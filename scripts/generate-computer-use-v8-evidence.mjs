...
const required = {
  ...
  'graph.runtime_held_approval': 'approval_resume_can_delegate_bearer_handling_to_the_runtime',
  ...
  'auth.verified_identity': 'verified_identity_must_match_runtime_principal_and_tenant',
  ...
  'wire.postcondition_roundtrip': 'types_round_trip_canonical_fixtures',
...
const sourcePaths = [
  ...
  'adk-computer-use/src/contracts/mod.rs', 'adk-computer-use/src/contracts/action.rs',
  'adk-computer-use/src/contracts/approval.rs', 'adk-computer-use/src/contracts/lease.rs',
  'adk-computer-use/src/contracts/receipt.rs', 'adk-computer-use/src/contracts/safety.rs',
  'adk-computer-use/src/contracts/session.rs', 'adk-computer-use/src/contracts/target.rs',
  'adk-computer-use/src/lib.rs', 'adk-computer-use/src/runtime/mcp.rs',
  'adk-computer-use/examples/macos/live_form.rs', 'adk-computer-use/examples/macos/macos_form_showcase.swift',
